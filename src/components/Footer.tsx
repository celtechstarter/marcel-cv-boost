...
<div>
  ...
  <div className="space-y-3">
    ...
    <div className="space-y-2 text-sm mt-3">
      ...
      <div className="flex items-center gap-2">
        <img src="https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg" alt="Facebook Icon" className="h-4 w-4 text-neutral-500 dark:text-neutral-400" />
        <a
      ...
      <div className="flex items-center gap-2">
        <img src="https://upload.wikimedia.org/wikipedia/commons/e/ec/TikTok_logo_2021.svg" alt="TikTok Icon" className="h-4 w-4 text-neutral-500 dark:text-neutral-400" />
        <a
      ...
      <div className="flex items-center gap-2">
        <img src="https://upload.wikimedia.org/wikipedia/commons/9/95/Instagram_logo_2022.svg" alt="Instagram Icon" className="h-4 w-4 text-neutral-500 dark:text-neutral-400" />
        <a
      ...
      <div className="flex items-center gap-2">
        <img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Twitter_Logo_2021.svg" alt="X (Twitter) Icon" className="h-4 w-4 text-neutral-500 dark:text-neutral-400" />
        <a
      ...
      <div className="flex items-center gap-2">
        <img src="https://upload.wikimedia.org/wikipedia/commons/4/42/YouTube_icon_%282013-2017%29.png" alt="YouTube Icon" className="h-4 w-4 text-neutral-500 dark:text-neutral-400" />
        <a
